...
public class UserDTO implements Serializable{
    ...
    public User toModel(){
    	User u = new User();
    	ArrayList<ObjectId> deptIds = new ArrayList<ObjectId>();
    	...
    	if (deptId != null) {
    		deptIds.add(new ObjectId(deptId));
    		u.setDepartmentIds(deptIds);
    	}
    	if (deptName != null) {
    		deptNames.add(deptName);
    		u.setDeptNames(deptNames);
    	}
    	u.setSubdomain(subdomain);
    	u.setIsCompany(isCompany);
	...
	public String toString() {
		return "UserDTO [id=" + id + ", userName=" + userName + ", first="
				+ first + ", last=" + last + ", password=" + password + ", companyId="
				+ companyId + ", DeptId=" + deptId + ", companyName" + companyName 
			    + ", subDomain=" + subdomain + ", deptName=" + deptName
			    + ", isCompany = " + isCompany + "]";
	}
}
